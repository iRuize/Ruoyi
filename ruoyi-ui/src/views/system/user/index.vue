        ...
        <pane size="84">
          <el-col>
            ...
            <el-row :gutter="10" class="mb8">
              <el-col :span="1.5">
                <el-button v-hasPermi="['system:user:add']" icon="el-icon-plus" plain size="mini" type="primary"
                           @click="handleAdd">新增
                </el-button>
              </el-col>
              <el-col :span="1.5">
            ...
            <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
              ...
              <el-table-column v-if="columns.userId.visible" key="userId" align="center" label="用户编号"
                               prop="userId"/>
              ...
              <el-table-column v-if="columns.phonenumber.visible" key="phonenumber" align="center" label="手机号码"
              ...
              <el-table-column v-if="columns.createTime.visible" align="center" label="创建时间" prop="createTime"
                               width="160">
                <template slot-scope="scope">
